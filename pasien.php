...
if (isset($_GET['aksi'])) {
    ...
    if ($aksi == 'hapus') {
        ...
        if ($result && $result->fetch_row()[0] > 0) {
            echo "<script>alert('Tidak dapat menghapus Data Pasien ini karena digunakan Di Tabel Periksa.');</script>";
        } else {
...
<body data-bs-theme="light">
    ...
    <div class="container">
        <h2 class="text-center mt-5" id="header">
            Selamat Menikmati di Halaman Pasien<?php if (isset($_SESSION['username'])){?>,
                <?php echo $_SESSION['username'] ?>
            <?php } ?></h2>
        <h4 class="text-center mt-4 mb-4">Form Pasien</h4>
